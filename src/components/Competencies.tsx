...
export const CompetenciesSection = () => {
  ...
  return (
    <section ref={containerRef} className="py-32 px-6 border-y border-white/5 relative overflow-hidden group/section">
      {/* Dynamic Background Glows */}
      <m.div 
        style={{ y: y1 }}
        className="absolute top-0 left-1/4 w-96 h-96 bg-brand-gold/5 blur-[120px] rounded-full animate-pulse pointer-events-none" 
      />
      <m.div 
        style={{ y: y2 }}
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-brand-accent/5 blur-[120px] rounded-full animate-pulse-slow pointer-events-none" 
      />
